...
public class AbsResponse<T> implements Serializable {
    ...
    public AbsResponse(BizException ex) {
        this.code = ex.getErrno();
...
//    public AbsResponse(int code, String msg, T data) { this(code, msg, null, data); }
    ...
    public AbsResponse<T> setResult(int code, String msg, T data) {
        this.code = code;
        this.msg = msg;
        this.data = data;
        return this;
